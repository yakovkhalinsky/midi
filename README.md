...
| --- | --- | --- |
| [Rack](https://yakov.khalinsky.com/midi/apps/rack/) | — | **Three OLEDs in a row, shared clock** — slots load TB-3PO, DrumMap, or Melogen; per-slot ÷N division and mute, global Web Audio / MIDI output, one MIDI device for all slots |
