...
| --- | --- | --- |
| [Rack](https://yakov.khalinsky.com/midi/apps/rack/) | — | Run **up to 3 apps in a column on one shared clock** (per-slot ÷N division, mute); each slot is a live compact instance of an app |
